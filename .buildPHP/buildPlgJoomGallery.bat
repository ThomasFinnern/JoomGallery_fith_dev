...
echo --- "%ExePath%php.exe" buildExtensionCmd.php -f ../../joomGallery_fith_dev/.buildPHP/buildPlgJoomGallery.tsk %OptionFile%
"%ExePath%php.exe" buildExtensionCmd.php -f ../../joomGallery_fith_dev/.buildPHP/buildPlgJoomGallery.tsk %OptionFile%
popd
