...
echo --- "%ExePath%php.exe" buildExtensionCmd.php -f ../../joomGallery_fith_dev/.buildPHP/buildPlgJoomConsole.tsk %OptionFile%
"%ExePath%php.exe" buildExtensionCmd.php -f ../../joomGallery_fith_dev/.buildPHP/buildPlgJoomConsole.tsk %OptionFile%
popd
