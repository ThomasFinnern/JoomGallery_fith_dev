...
echo --- "%ExePath%php.exe" buildExtensionCmd.php -f ../../joomGallery_fith_dev/.buildPHP/build_api01.tsk %OptionFile%
"%ExePath%php.exe" buildExtensionCmd.php -f ../../joomGallery_fith_dev/.buildPHP/build_api01.tsk %OptionFile%
popd
