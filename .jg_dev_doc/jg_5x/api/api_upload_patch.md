...
Actually it is not working 2026.06.30
...
> ```shell
> curl -s --show-error  -X PATCH "http://127.0.0.1/joomgallery5x_dev/api/index.php/v1/joomgallery/upload_image_file/1" -F content=@\"2016-11-07_00012.jpg.base64\"  -H "Content-Type: multipart/mixed" -H "X-Joomla-Token:  ..."
> ```
...
> ```http
> ###
> PATCH http://127.0.0.1/joomgallery5x_dev/api/index.php/v1/joomgallery/upload_image_file/1
