...
Possibilities in Image selection view:  
...
Possibilities in Image edit view:  
...
Possibilities in Upload size limits (php, ...):  
...
(5) Joomla media limit: Set in Joomla configuration 
