...
ECHO ----------------------------------------------
ECHO command
REM vendor/bin/phpstan analyse src tests
...
REM "C:\Users\finnern\AppData\Roaming\Composer\vendor\bin\phpstan.bat" --help
"C:\Users\finnern\AppData\Roaming\Composer\vendor\bin\phpstan.bat" --help
GOTO :EOF
