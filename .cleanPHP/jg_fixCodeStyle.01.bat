...
ECHO php ./administrator/com_joomgallery/vendor/bin/php-cs-fixer fix .\  --verbose --config=.\.php-cs-fixer.dist.php 
php ./administrator/com_joomgallery/vendor/bin/php-cs-fixer fix .\ >%actualPath%\01.php-cs-fixer.log --verbose --config=.\.php-cs-fixer.dist.php  
REM if errorlevel 1 (
...
ECHO php ./administrator/com_joomgallery/vendor/bin/php-cs-fixer fix .\  --verbose  --config=.\.php-cs-fixer.dist.php  
php ./administrator/com_joomgallery/vendor/bin/php-cs-fixer fix .\ >%actualPath%\03.php-cs-fixer.log --verbose  --config=.\.php-cs-fixer.dist.php  
